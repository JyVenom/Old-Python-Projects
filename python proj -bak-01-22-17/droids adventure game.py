...
print('\n' * 100)
print('\n\n[-Droids : by jerry , i hope you like it!')
print('\n\n\n------------------------')
print('        DROIDS')
print('------------------------')
...
def access_code(inventory):
    code = '%d%d%d' % (randint(0,0), randint(0,0), randint(0,0))
    guess = input('\n[KEYPAD]> ')
    guesses = 0
                    
    while guess != code and guess != 'jerry' and guesses <4:
        print('\n* ACCESS - DENIED *')
        guesses += 1
        guess = input('\n[KEYPAD]> ')
        if guess == 3636123 :
    ...
    if guess == code or guess == 'jerry3636':
        repair_droid(inventory)
    else:
        print('\n....')
        time.sleep(1)
...
def getcmd(cmdlist):
    ...
    if cmd in cmdlist:
        ...
        print('\n........')
        time.sleep(1)
        print('\n[--Paradroid -- published by jerry yang--]')
        time.sleep(1)
